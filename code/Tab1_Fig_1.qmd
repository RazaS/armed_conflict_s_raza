...
This table summaries characteristics of the data set across countries which had a conflict and those that did not
...
This figure shows countries which experienced increasing maternal mortality
...
# Identify countries with an increase in MatMort from 2000 to 2017
...
# Filter the original dataframe to include only those countries with data
plot_data <- df %>%
